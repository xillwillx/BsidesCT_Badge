...
# added, 9-26-17, cbs #######
hidArraySize = len(hid_array)
print '%d HID array bytes (%d HID codes)' % (hidArraySize, hidArraySize/3)
if hidArraySize > 1800:
    print '[!] ######### error: HID array too big for modified firmware, ~600 codes max'
    sys.exit(-1)
# ###########################
